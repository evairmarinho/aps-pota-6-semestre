...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("Média de comparações: "+bubbleSort.calculaMedia(bubbleSort.comparacaoVetores("bubbleSort", vetoresTam5)));
        ...
        System.out.println("Média de comparações: "+bubbleSort.calculaMedia(bubbleSort.comparacaoVetores("bubbleSort", vetoresTam10)));
        ...
        System.out.println("Média de comparações: "+bubbleSort.calculaMedia(bubbleSort.comparacaoVetores("bubbleSort", vetoresTam100)));
        ...
        System.out.println("Média de comparações: "+bubbleSort.calculaMedia(bubbleSort.comparacaoVetores("bubbleSort", vetoresTam1000)));
        ...
        System.out.println("Média de comparações: "+bubbleSort.calculaMedia(bubbleSort.comparacaoVetores("bubbleSort", vetoresTam10000)));
        ...
        */
        ...
        /*
        System.out.println("INÍCIO - Insertion Sort");
        
        System.out.println("FIM - Insertion Sort");
        */
